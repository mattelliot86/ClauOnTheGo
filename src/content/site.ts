// Spanish site content used to populate the example page.
// This file exports a typed object containing all of the
// textual information used across the various components.
// Having the content in one place makes it easy to tweak
// the copy or swap languages without touching the layout code.
...
export const siteContent = {
  ...
  filosofia: {
    ...
    objetivo:
      "No busco crecer seguidores por crecer: mi objetivo es que tu marca sea profesional, confiable y alineada a la imagen que quieres proyectar, para que cada visita se convierta en una oportunidad real.",
    porqueElegirme: {
  ...
  proceso: {
    ...
    note:
      "Todo el proceso está enfocado en crecimiento sostenible, no en publicaciones sin sentido.",
  },
  paquetes: {
    ...
    planes: [
      {
        ...
        paraQuien:
          "Negocios que recién empiezan o tienen poca presencia digital y necesitan orden, claridad y una base profesional.",
        enfoque:
          "Organizar tu cuenta, mejorar tu imagen y crear una presencia coherente desde el inicio.",
        incluye: [
          "Diagnóstico inicial",
        ...
        objetivo:
          "Construir una presencia clara, ordenada y profesional desde el inicio.",
      },
      {
        name: "Plan Crecimiento",
        price: "desde S/ 1,050 mensuales — Más recomendado",
        paraQuien:
          "Marcas con presencia en Instagram que no están obteniendo resultados claros o han sido mal gestionadas.",
        enfoque:
          "Convertir tu contenido en una herramienta real de crecimiento y posicionamiento.",
        incluye: [
      ...
      },
      {
        ...
        paraQuien:
          "Marcas que buscan verse premium, diferenciarse y consolidarse como referentes en su sector.",
        ...
        objetivo:
          "Construir autoridad, diferenciación y presencia sólida en el mercado.",
      },
    ],
  },
  contacto: {
